...
<html>
 <head>
    ...
    <div class="left">
        ...
        |
        <a href="/api/index.php?s=/Admin/TopicComment/logout">退出</a>
    </div>
    <div class="right">
	...
	<div id="content" class="white">
        ...
        <div class="bloc">
		    <div class="title"><?php if(is_array($topCates)): $i = 0; $__LIST__ = $topCates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/api/index.php?s=/Admin/TopicComment/index/cid/<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?></div>
		    <div class="content"> 
				...
				<table>
		            ...
		            <tbody>
		            	<?php if(is_array($commentlist)): $i = 0; $__LIST__ = $commentlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		                    ...
		                    <td style="text-align:center;"><a href="/api/index.php?s=/Admin/TopicComment/del/cid/<?php echo ($cid); ?>/id/<?php echo ($vo["id"]); ?>" title="Delete this content" onclick="return confirm('你确定要删除这条评论吗？');"><img src="/api/Public/Admin/img/icons/actions/delete.png" alt="删除" /></a></td>
	...
	<script type="text/javascript">
		/*function checkComment(id,target){
			var $target=$(target);
			$.ajax({
				url:'/api/index.php?s=/Admin/TopicComment/checkComment',
				data:{"id":id},
				type:'post',
				dataType:'json',
