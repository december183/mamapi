...
<html>
 <head>
	...
	<div id="content" class="white">
        <h1><img src="/api/Public/Admin/img/icons/posts.png" alt="" /> 属性管理-修改属性</h1>
        <div class="bloc">
		    <div class="title"><a href="/api/index.php?s=/Admin/Attr/index">属性列表</a> &gt; <a href="/api/index.php?s=/Admin/Attr/add">添加属性</a> &gt; <a href="/api/index.php?s=/Admin/Attr/edit">修改属性</a></div>
		    <form method="post" action="">
		    <input type="hidden" name="id" value="<?php echo ($oneAttr["id"]); ?>" />
		    <input type="hidden" name="attrvalue" id="attrvalue" value="<?php echo ($oneAttr["value"]); ?>" />
		    <div class="content">
	    		<div class="input">属性名称：<input type="text" name="name" value="<?php echo ($oneAttr["name"]); ?>" /> <em class="red">*</em></div>
	    		<div class="input">
		            属性类型：
		            <select name="type" id="type">
		            	<option value="0">--请选择属性类型--</option>
		                <option value="1" <?php if($oneAttr['type'] == 1): ?>selected="selected"<?php endif; ?>>单行文本</option>
		                <option value="2" <?php if($oneAttr['type'] == 2): ?>selected="selected"<?php endif; ?>>单选按钮</option>
		                <option value="3" <?php if($oneAttr['type'] == 3): ?>selected="selected"<?php endif; ?>>多选按钮</option>
		                <option value="4" <?php if($oneAttr['type'] == 4): ?>selected="selected"<?php endif; ?>>多行文本</option>
