...
<html>
 <head>
    ...
    <div class="left">
        ...
        |
        <a href="/api/index.php?s=/Admin/AdverType/logout">退出</a>
    </div>
</div>                
	...
	<div id="content" class="white">
        <h1><img src="/api/Public/Admin/img/icons/posts.png" alt="" /> 广告类型管理-添加广告类型</h1>
        <div class="bloc">
		    <div class="title"><a href="/api/index.php?s=/Admin/AdverType/index">广告类型列表</a> &gt; <a href="/api/index.php?s=/Admin/AdverType/add">添加广告类型</a> &gt; <a href="/api/index.php?s=/Admin/AdverType/edit/id/<?php echo ($oneAdvertype["id"]); ?>">修改广告类型</a></div>
		    <form method="post" action="">
		    <input type="hidden" name="id" value="<?php echo ($oneAdvertype["id"]); ?>" />
		    <div class="content">
	    		<div class="input">类型名称：<input type="text" name="name" value="<?php echo ($oneAdvertype["name"]); ?>" /> <em class="red">*</em></div>
	    		<div class="input">广告宽度：<input type="text" name="width" value="<?php echo ($oneAdvertype["width"]); ?>" /> <em class="red">*</em></div>
	    		<div class="input">广告高度：<input type="text" name="height" value="<?php echo ($oneAdvertype["height"]); ?>" /> <em class="red">*</em></div>
		        <div class="input textarea">
		            <span class="middle">类型描述：</span><textarea name="summary" rows="3" cols="5"><?php echo ($oneAdvertype["summary"]); ?></textarea>
		        </div>
		        <div class="input">
		        	是否启用：
		            <input type="radio" id="radio1" name="status" value="1" <?php if($oneAdvertype['status'] == 1): ?>checked="checked"<?php endif; ?>/><label for="radio1" class="inline">是</label>
		            <input type="radio" id="radio2"  name="status" value="0" <?php if($oneAdvertype['status'] == 0): ?>checked="checked"<?php endif; ?>/><label for="radio2" class="inline">否</label>
		        </div>
		        <div class="submit">
